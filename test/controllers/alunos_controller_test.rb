...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { nome: @aluno.nome, password: @aluno.password, ra: @aluno.ra } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { nome: @aluno.nome, password: @aluno.password, ra: @aluno.ra } }
