...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { float: @produto.float, integer: @produto.integer, nome: @produto.nome, quantidade: @produto.quantidade, string: @produto.string, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { float: @produto.float, integer: @produto.integer, nome: @produto.nome, quantidade: @produto.quantidade, string: @produto.string, valor: @produto.valor } }
